//迁徙图
    ...
    var GZData = [
    [{name:'秦皇岛'}, {name:'石家庄',value:60}],
    [{name:'秦皇岛'}, {name:'北京',value:50}],
    [{name:'秦皇岛'}, {name:'唐山',value:40}]
    ];

    var planePath = 'path://M10,80,Q,95,10,180,80';
    ...
    var color = ['#75cf77', '#ffa022', '#ff4f4b'];
    var series = [];
    [['秦皇岛', BJData], ['秦皇岛', SHData], ['秦皇岛', GZData]].forEach(function (item, i) {
        series.push({
            name: item[0] + ' Top10',
            type: 'lines',
            zlevel: 1,
...
option = {
    ...
    yAxis: {
        type: 'category',
        data: ['邯郸市','河南省','邢台市','辛集市','张家口市','山西省','承德市']
    },
    series: [
        {
            name: '工业源',
        ...
        },
        {
            ...
            data: [123, 456, 789, 345, 765, 330, 1310]
        }
    ]
};;
if (option && typeof option === "object") {
