...
document.getElementById('map3').onmousewheel = function (e){
...
$.ajax({ url: "map.json" }).done(function(json) {
  $.each(json, function(name, aqi){ 
    option.series[0].data.push(
      {name: name, value: aqi}
      );
  });
  option.timeline.data.push('2002')
  option.timeline.data.push('2003')
  option.timeline.data.push('2004')
  option.timeline.data.push('2005')
