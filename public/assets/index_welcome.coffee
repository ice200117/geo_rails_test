...
#$(document).on 'click', 'body', ->
  $.ajax(url: "/counties/lookup",  dataType: "json").done (json) ->
    ...
    infoWindow = new BMap.InfoWindow("World", opts)
...
# echarts路径配置
  require.config
    paths: 
      ...
      zrender: 'assets/vendor/zrender'

    packages: [ 
      {
      name: 'BMap'
      location: 'assets/vendor/BMap'
      main: 'main'
      } 
    ]
...
# 基于准备好的dom，初始化echarts图表
   ...
   require [
    ...
    'BMap'
    'echarts/chart/map'
  ], (echarts, BMapExtension) ->
      $('#main2')
      # 初始化地图
      BMapExt = new BMapExtension($('#main2')[0], BMap, echarts, enableMapClick: false)
      map = BMapExt.getMap()
      ...
      myChart2 = BMapExt.initECharts(container)
