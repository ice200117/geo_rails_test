...
RSpec.describe "forecast_48s/new", type: :view do
  before(:each) do
    assign(:forecast_48, Forecast48.new(
      :station_id => nil,
      :pattern => "MyString",
      :pm25 => 1.5,
      :pm10 => 1.5,
  ...
  it "renders new forecast_48 form" do
    render

    assert_select "form[action=?][method=?]", forecast_48s_path, "post" do
