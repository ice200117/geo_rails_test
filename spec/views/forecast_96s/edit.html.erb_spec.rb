...
RSpec.describe "forecast_96s/edit", type: :view do
  before(:each) do
    @forecast_96 = assign(:forecast_96, Forecast96.create!(
      :station_id => nil,
      :pattern => "MyString",
      :pm25 => 1.5,
      :pm10 => 1.5,
  ...
  it "renders the edit forecast_96 form" do
    render

    assert_select "form[action=?][method=?]", forecast_96_path(@forecast_96), "post" do
