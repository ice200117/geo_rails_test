...
RSpec.describe "forecast_24s/new", type: :view do
  before(:each) do
    assign(:forecast_24, Forecast24.new(
      :station_id => nil,
      :pattern => "MyString",
      :pm25 => 1.5,
      :pm10 => 1.5,
  ...
  it "renders new forecast_24 form" do
    render

    assert_select "form[action=?][method=?]", forecast_24s_path, "post" do
